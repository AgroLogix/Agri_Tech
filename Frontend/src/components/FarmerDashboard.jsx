...
const FarmerDashboard = () => {
  ...
  // ✅ Handle confirm booking with better error handling
const handleConfirmBooking = async (e) => {
  ...
  // ✅ Validate form data
  if (!bookingData.productName || !bookingData.quantity || 
        ...
        <div className="current-booking">
          ...
          {currentBooking ? (
            <div className="current-booking-card">
              <h4>{currentBooking.vehicleName}</h4>
              <p>
                <strong>Provider:</strong>{" "}
                {currentBooking.providerId?.name || "Loading..."}
              </p>
              <p>
